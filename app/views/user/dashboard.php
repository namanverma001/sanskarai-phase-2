                 ...
                 color: white; padding: 4px 10px; border-radius: 20px; font-size: 0.72rem; font-weight: 600;">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                     ...
                     border-radius: 12px; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.2rem; flex-shrink: 0;">
                        ...
                        <div>
                            <h4 style="margin: 0; font-size: 1rem; color: #1E1E2E;"><?= htmlspecialchars($festival['name']) ?>
                            </h4>
                    ...
                    <?php if ($isPrepTime): ?>
                        <div
                            style="background: rgba(249,115,22,0.1); color: #C2410C; padding: 6px 10px; border-radius: 8px; font-size: 0.78rem; margin-bottom: 12px; display: inline-flex; align-items: center; gap: 5px;">
                            <i class="fas fa-exclamation-circle"></i> Start preparing now!
                        </div>
                    <?php elseif ($festival['preparation_days'] > 0): ?>
                        <div
                            style="background: rgba(99,102,241,0.08); color: #4338CA; padding: 6px 10px; border-radius: 8px; font-size: 0.78rem; margin-bottom: 12px; display: inline-flex; align-items: center; gap: 5px;">
                            <i class="fas fa-clock"></i> Start preparing <?= $festival['preparation_days'] ?>
                            day<?= $festival['preparation_days'] > 1 ? 's' : '' ?> before
                        </div>
                    <?php endif; ?>
...
<div class="content-grid">
                ...
                <?php foreach (array_slice($featuredRituals, 0, 3) as $ritual): ?>
                    <div class="ritual-card">
                        ...
                        <div class="ritual-meta">
                            ...
                            <span style="margin-left: 10px;"><i class="fas fa-clock"></i> <?= $ritual['duration_minutes'] ?>
                                min</span>
                        </div>
    ...
    <div>
            ...
            <?php if (!empty($featuredInsights)): ?>
                <?php foreach ($featuredInsights as $insight): ?>
                    <div style="margin-bottom: 15px; padding-bottom: 15px; border-bottom: 1px solid #E5E7EB;">
                        <a href="/user/insights/<?= $insight['slug'] ?>"
        ...
        <div class="card" style="background: linear-gradient(135deg, #FF6B35 0%, #F59E0B 100%); color: white;">
            ...
            <p style="font-size: 0.9rem; margin-bottom: 15px;">Get personalized ritual recommendations based on your
                needs.</p>

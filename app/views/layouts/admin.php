        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .sidebar {
                ...
                transition: transform 0.3s ease;
                z-index: 999;
                /* Below navbar (1000) so toggle button stays visible */
                display: flex;
                flex-direction: column;
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                <div class="menu-section">
                    ...
                    <a href="/admin/dashboard"
                        class="menu-item <?= strpos($_SERVER['REQUEST_URI'], '/admin/dashboard') !== false ? 'active' : '' ?>">
                ...
                <div class="menu-section">
                    ...
                    <a href="/admin/users"
                        class="menu-item <?= strpos($_SERVER['REQUEST_URI'], '/admin/users') !== false ? 'active' : '' ?>">
                        <i class="fas fa-users"></i> <span>Users</span>
                    </a>
                    <a href="/admin/pandits/pending"
                        class="menu-item <?= strpos($_SERVER['REQUEST_URI'], '/admin/pandits') !== false ? 'active' : '' ?>">
                        <i class="fas fa-user-check"></i> <span>Pandit Approval</span>
                    </a>
                    <a href="/admin/rituals"
                        class="menu-item <?= strpos($_SERVER['REQUEST_URI'], '/admin/rituals') !== false ? 'active' : '' ?>">
                    ...
                    <a href="/admin/feedbacks"
                        class="menu-item <?= strpos($_SERVER['REQUEST_URI'], '/admin/feedbacks') !== false ? 'active' : '' ?>">
                ...
                <div class="menu-section">
                    ...
                    <a href="/admin/profile"
                        class="menu-item <?= strpos($_SERVER['REQUEST_URI'], '/admin/profile') !== false ? 'active' : '' ?>">
            ...
            <div class="sidebar-footer mobile-only"
                style="padding: 20px; margin-top: auto; border-top: 1px solid rgba(255,255,255,0.1);">
                <a href="/admin/profile" class="btn btn-outline-light mb-3"
                    style="width: 100%; display: flex; justify-content: center; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 15px;">

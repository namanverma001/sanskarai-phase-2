...
<head>
    ...
    <meta name="description" content="Discover the sacred world of Hindu rituals with AI-powered guidance. Connect with verified Pandits, learn traditional ceremonies, and preserve your family's spiritual heritage.">
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @keyframes badgeGlow {
            ...
            50% { box-shadow: 0 0 40px rgba(255, 153, 51, 0.4), 0 0 60px rgba(255, 153, 51, 0.2); }
        }
        ...
        .deco-item:nth-child(1) { top: 10%; left: 10%; }
        .deco-item:nth-child(2) { top: 20%; right: 15%; }
        .deco-item:nth-child(3) { bottom: 15%; left: 20%; }
        .cta h2 {
            font-size: 2.5rem;
            font-weight: 700;
            margin-bottom: 20px;
        ...
        .footer-links a:hover { color: var(--saffron); transform: translateX(5px); }
        .footer-bottom {
            display: flex;
            justify-content: space-between;
            align-items: center;
                    ...
                    <div class="user-profile-dropdown" id="userDropdown">
                        <button class="user-profile-btn" id="userDropdownBtn" aria-expanded="false">
                            ...
                            <div class="user-info">
                                ...
                                <span class="user-role-badge" style="background: <?= $roleDisplay['color'] ?>20; color: <?= $roleDisplay['color'] ?>;">
                                    <?= $roleDisplay['name'] ?>
                                </span>
                            </div>

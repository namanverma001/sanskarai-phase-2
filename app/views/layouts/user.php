                ...
                <div class="user-profile-dropdown" id="userDropdown">
                    <button class="user-profile-btn" id="userDropdownBtn" aria-expanded="false">
                        ...
                        <div class="nav-user-info">
                            <span class="nav-user-name"><?= htmlspecialchars($currentUser['name'] ?? 'User') ?></span>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar expanded" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <div class="menu-section">
                    <div class="menu-section-title">Rituals</div>
                    <a href="/user/rituals"
        ...
        <main class="main-content">
            ...
            <?php if (isset($_SESSION['flash']['success'])): ?>
                <div class="alert alert-success"><i class="fas fa-check-circle"></i>
                    <?= htmlspecialchars($_SESSION['flash']['success']) ?></div>
    ...
    <footer class="main-footer">
        <div class="footer-content">
            ...
            <div class="footer-links">
                ...
                <a href="/user/families">My Family</a>
            </div>
            <div class="footer-links">
                <h4>Services</h4>
                <a href="/user/select-pandit">Find Pandit</a>
                <a href="/user/bookings">My Bookings</a>
                <a href="/user/shopping-list">Shopping List</a>
                <a href="/user/insights">Cultural Insights</a>
            </div>
            <div class="footer-links">
                <h4>Contact</h4>
